-- Refactor get_analytics_devices, get_analytics_browsers, get_analytics_operating_systems RPCs
-- to return actual session counts alongside percentages and consolidate remaining categories into Others
